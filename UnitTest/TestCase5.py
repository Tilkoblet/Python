...
options     = {
    ...
    "json": {
        ...
        "UserName"              : aesEncrypt(aesKey, aesIv, open("D:\\username.txt", "r", encoding='utf-8').read()),
        "BirthDate"             : aesEncrypt(aesKey, aesIv, open("D:\\birthdate.txt", "r").read()),
        "IdentityNumber"        : aesEncrypt(aesKey, aesIv, open("D:\\identitynumber.txt", "r").read()),
        "MobileCorp"            : "1",
        "PhoneNumber"           : aesEncrypt(aesKey, aesIv, open("D:\\phonenumber.txt", "r").read()),
        "RegionCode1"           : "009",
    },
}
...
with open("D:\\captcha.png", "wb") as f:
    f.write(base64.b64decode(res.json()["Result"]["CaptchaImage"]))
